...
class CreateAddCountryTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('countries', function (Blueprint $table) {
            ...
            $table->double('SurfaceArea', 10, 2)->default(0.00);
            $table->integer('IndepYear')->nullable();
        ...
        DB::statement("
INSERT INTO `countries` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`)
VALUES
